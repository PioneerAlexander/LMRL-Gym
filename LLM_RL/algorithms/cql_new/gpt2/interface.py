...
from LLM_RL.algorithms.cql_new.base_interface import CQLTrain, CQLInference
        ...
        def _step(
            ...
            def grad_loss(base_params: PyTree, q1_head_params: PyTree, q2_head_params: PyTree, v_head_params: PyTree, prng_key: jax.random.PRNGKeyArray):
                ...
                if next_token_ids is not None:
                    ...
                    target_q1_final = next_token_target_q1_head_output[:, last_next_token_idxs] * (1 - next_dones.astype(jnp.float32))
                    target_q2_final = next_token_target_q2_head_output[:, last_next_token_idxs] * (1 - next_dones.astype(jnp.float32))
                else:
...
class GPT2CQLInference(CQLInference):
    @classmethod
    def load_inference(
        cls, 
