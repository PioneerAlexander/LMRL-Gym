...
from LLM_RL.algorithms.cql_new.gpt2.interface import GPT2CQLInference
...
def train_loop(
    trainer: CQLTrain, 
    inference: Union[ValueRLInference, CQLInference], 
    ...
    **loop_state: Dict[Hashable, Any], 
    ...
    def _inference_update():
        ...
        elif isinstance(inference,  GPT2CQLInference):
